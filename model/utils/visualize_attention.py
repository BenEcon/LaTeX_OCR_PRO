...
def vis_attention_gif(img_path, path_to_save_attention, hyps, full_latex=False):
    ...
    attention_filename = path_to_save_attention+'_visualization.gif'
    anim.save(attention_filename, dpi=80, writer='imagemagick')
    print("finish!")
...
def vis_img_with_attention(img2SeqModel, img_path, dir_output):
    ...
    return vis_attention_gif(img_path, path_to_save_attention, hyps)
